...
const Footer = () => {
    ...
    return (
        ...
        <div className='w-full  px-[50px] py-[40px] bg-black text-white text-lg flex flex-col gap-8'>
            {location.pathname == '/products' && <div className="p-4 py-6 rounded-lg bg-gray-50 md:p-8">
                <form>
                    ...
                    <div className="w-full mt-4">
                        ...
                        <textarea className="block w-full h-32 px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg md:h-56 " placeholder="Message"></textarea>
                    </div>
